            ...
            <Container maxWidth={false} sx={{px: {xs: 2, md: 8}}}>
                <Grid container spacing={4} alignItems="flex-start" justifyContent="space-between">
                    ...
                    <Grid>
                        ...
                        <Box sx={{
                            ...
                            <div><a href="/tos" style={{color: 'inherit', textDecoration: 'none'}}>Điều Khoản Sử Dụng</a>
                            </div>
                            <div><a href="/faq" style={{color: 'inherit', textDecoration: 'none'}}>Câu Hỏi Thường Gặp</a></div>
                        </Box>
                    </Grid>
                ...
                <Box sx={{
                    ...
                    <Typography variant="body2" align="center" sx={{color: 'rgba(255,255,255,0.7)'}}>
                        © {new Date().getFullYear()} Admission Hub - Nền Tảng Tư Vấn Tuyển Sinh. Tất cả quyền được bảo lưu. | Thiết kế với ❤️ cho giáo dục
                    </Typography>
                </Box>
            </Container>
        </Box>
